...
public class OrderDetailsAdapter extends RecyclerView.Adapter<OrderDetailsAdapter.OrderDetailsViewHolder> {
    ...
    public OrderDetailsAdapter(Context mContext, List<OrderDetailsDto> mData, OrderDetailsViewHolder.RecyclerViewClickListener listener){
    ...
    @NonNull
    @Override
    public OrderDetailsAdapter.OrderDetailsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View layout;
        layout = LayoutInflater.from(mContext).inflate(R.layout.order_details_layout,viewGroup,false);
        return new OrderDetailsViewHolder(layout,mContext,mData,clicklistener);
    }

    @Override
    public void onBindViewHolder(OrderDetailsAdapter.OrderDetailsViewHolder holder, int position) {
